 ...
 */
final class Version20240112143034 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, content CLOB DEFAULT NULL, image VARCHAR(255) NOT NULL, status BOOLEAN NOT NULL)');
